...
public class Cilindro extends FiguraGeométrica {
    ...
    //Método para calcular el volumen de un cilindro @return El volumen de un cilindro
    public double calcularVolumen() {
        double volumen = Math.PI * altura * Math.pow(radio, 2.0);
        return volumen;
    }
    
    //Método para calcular la superficie de un cilindro @return La superficie de un cilindro
