...
public class Piramide extends FiguraGeométrica {
    ...
    private double altura; //Atributo que identifica la altura de un pirámide
    ...
    * @param apotema Parámetro de define el apotema de una pirámide*/
    ...
    //Método para calcular el volumen de una pirámide @return El volumen de una pirámide
    public double calcularVolumen() {
        double volumen = (Math.pow(base, 2.0) * altura) / 3.0;
        return volumen;
    }
    
    //Método para calcular la superficie de una pirámide @return La superficie de una pirámide
